...
$passwordCheck = mysqli_query($con, "SELECT * FROM users WHERE usr_uname='$username' AND usr_pword='$oldMd5'");
...
$query = mysqli_query($con, "UPDATE users SET usr_pword='$newMd5' WHERE usr_uname='$username'");
